...
PROC IMPORT 
	DATAFILE = "\\mktg-app01\E\cepps\Web_Report\Lending_Tree\Reports\All_Lending_Apps_OwnType_Purpose.xlsx"
	DBMS = EXCEL 
	OUT = OWNER_TYPE_1 
	REPLACE;
RUN;
...
PROC IMPORT 
	DATAFILE = 
		"\\mktg-app01\E\cepps\Web_Report\Lending_Tree\Reports\All_Lending_Apps_OwnType_Purpose.xlsx" 
...
PROC EXPORT 
	DATA = OWNER_TYPE 
	OUTFILE = "\\mktg-app01\E\cepps\Web_Report\Lending_Tree\Reports\All_Lending_Apps_OwnType_Purpose.xlsx"  
	DBMS = XLSX REPLACE;
RUN;
