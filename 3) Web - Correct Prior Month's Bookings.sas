...
%LET NEW_MONTH_FILE_2 = MARCH_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201803;
%LET ONE_MO_AGO = 201802;
%LET TWO_MO_AGO = 201801;
%LET TWO_MO_AGO_APPS = JANUARY_APPS;
%LET TWO_MO_AGO_APPS_NEW = JANUARY_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_JANUARY;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_JANUARY;
%LET ONE_MO_BOOKED_2 = FEBRUARY_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = FEBRUARY_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_FEBRUARY_FINAL;
%LET ONE_MO_AGO_APPS = FEBRUARY_APPS;
%LET ONE_MO_AGO_APPS_NEW = FEBRUARY_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = FEBRUARY_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_MAR2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_MAR2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_MAR2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;